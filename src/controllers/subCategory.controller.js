...
//   }
// }
exports.addsubCategory = (req, res) => { // Change your function name
  var newsubCategory = new subCategoryModel(req.body) // Change model name 
  newsubCategory.save((err, doc) => { // past model body
    if (!err) {
      res
        .status(200)
        .send({ success: true, message: 'Sub Category Created Successfully!' }) //Change your meassage
